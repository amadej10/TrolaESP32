...
void getTrolaDataAndDisplay()
{
  ...
  if (!client.connect(server, 443)){
    ...
    // Extract values
    JsonObject& stations0 = root["stations"][0];
    const char* stations0_number = stations0["number"]; // "603031"
    const char* stations0_name = stations0["name"]; // "Krimska"
    
    JsonArray& stations0_buses = stations0["buses"];

    JsonObject& stations0_buses0 = stations0_buses[0];
    ...
    JsonArray& stations0_buses0_arrivals = stations0_buses0["arrivals"];
    int stations0_buses0_arrivals0 = stations0_buses0_arrivals[0]; // 4
    int stations0_buses0_arrivals1 = stations0_buses0_arrivals[1]; // 35
    int stations0_buses0_arrivals2 = stations0_buses0_arrivals[2]; // 65
    
    JsonObject& stations0_buses1 = stations0_buses[1];
    const char* stations0_buses1_direction = stations0_buses1["direction"]; // "Vižmarje"
    const char* stations0_buses1_number = stations0_buses1["number"]; // "1"
    
    JsonArray& stations0_buses1_arrivals = stations0_buses1["arrivals"];
    int stations0_buses1_arrivals0 = stations0_buses1_arrivals[0]; // 4
    int stations0_buses1_arrivals1 = stations0_buses1_arrivals[1]; // 35
    int stations0_buses1_arrivals2 = stations0_buses1_arrivals[2]; // 65
    
    JsonObject& stations0_buses2 = stations0_buses[2];
    const char* stations0_buses2_direction = stations0_buses2["direction"]; // "Vižmarje"
    const char* stations0_buses2_number = stations0_buses2["number"]; // "1D"
    
    JsonArray& stations0_buses2_arrivals = stations0_buses2["arrivals"];
    int stations0_buses2_arrivals0 = stations0_buses2_arrivals[0]; // 20
    int stations0_buses2_arrivals1 = stations0_buses2_arrivals[1]; // 50
    int stations0_buses2_arrivals2 = stations0_buses2_arrivals[2]; // 80
